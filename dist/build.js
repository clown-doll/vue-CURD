...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.app{ margin: 100px auto 0; width: 600px; font-family: Helvetica, simhei, Arial, sans-serif;}\n\n.btn{ padding: 4px 8px; border: 0; border-radius: 3px; cursor: pointer; color: #fff;}\n.btn:hover{ opacity: 0.9;}\n.btn-large{ padding: 8px 20px; }\n.btn-red{ background-color: salmon; }\n.btn-blue{ background-color: #0090d3; }\ninput{ padding: 3px 6px; border: 1px solid #ccc; line-height: 1.8;}\n\n.search{ text-align: center; }\n.search input{ padding: 3px 6px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tableComponent = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dialogComponent = __webpack_require__(81);
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        openNewItemDialog: function openNewItemDialog(title) {
	            this.mode = 1;
	            this.title = title;
	        ...
	        openEditItemDialog: function openEditItemDialog(tit) {
	        ...
	        findItemByKey: function findItemByKey(key) {
	            var keyColumn = this.keyColumn,
	                dataLen = this.dataList.length;
	            for (var i = 0; i < dataLen; i++) {
	        ...
	        copyCurItem: function copyCurItem(cur) {
	            var c = c || {};
	            for (var pro in cur) {
	                if (cur.hasOwnProperty(pro)) {
	                    if ((0, _typeof3.default)(cur[pro]) === 'object') {
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    events: {
	        "showDialog": function showDialog(flag) {
	            this.show = flag;
	        }
	    },
	    methods: {
